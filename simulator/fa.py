...
def Q_learning_with_value_approximation(env,estimator, epoch_num, discount_factor=1.0, epsilon=0.1, epsilon_decay=1.0):
    ...
    for i_epoch_num in range(epoch_num):
        ...
        policy = make_epsilon_greedy_policy(estimator,env.action_space.n,epsilon*epsilon_decay**i_epoch_num)
        state = env.reset()
